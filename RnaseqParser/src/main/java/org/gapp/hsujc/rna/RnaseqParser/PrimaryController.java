...
public class PrimaryController implements Initializable {
    ...
    private void exportTCC(ActionEvent e) {
        ...
        if(t.getText().equals("SampleID")) continue;
        sb.append("SampleID,"+t.getText()+"\n");
        //System.out.println("SampleID,"+t.getText());
        for(Map<String,String> m:checkdata) {
        String s =  m.get("SampleID").replace("-", ".");
        if(m.get(t.getText()).isEmpty() || m.get(t.getText()) == null || m.get(t.getText()).isBlank()) {
        	Alert alert = new Alert(AlertType.INFORMATION);
			alert.setTitle("Warning");
			//alert.setHeaderText("Information Alert");
			String u = "factor "+t.getText()+" have empty!";
			...
			return;
        	 ...
        	 sb.append(s+","+m.get(t.getText())+"\n");
        }
       
        //System.out.println(s+","+m.get(t.getText()));
        }      
        }
